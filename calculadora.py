...
"""
# mais uma vez aqui pois estou juntando2 repositorios para ver se salvam
...
# importação apenas dos elementos necessários segundo
# o conceito organizacional do flake8
...
button_clear1 = Button(root, text="Clear", padx=79,
                       pady=20, command=button_clear)

button_subtract1 = Button(root, text="-", padx=40,
                          pady=20, command=button_subtract)
button_multiply1 = Button(root, text="*", padx=40,
                          pady=20, command=button_multiply)
button_divide1 = Button(root, text="/", padx=41,
...
button_subtract1.grid(row=6, column=0)
